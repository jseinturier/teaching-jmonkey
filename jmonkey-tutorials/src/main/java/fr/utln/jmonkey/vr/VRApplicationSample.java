 ...
 */
public class VRApplicationSample extends SimpleApplication {

	private static final Logger logger = Logger.getLogger(VRApplicationSample.class.getName());
    ...
    public VRApplicationSample(AppState... initialStates) {
        super(initialStates);
    ...
    public void simpleInitApp() {    
        ...
        Spatial sky = SkyFactory.createSky(getAssetManager(), "Textures/Sky/Earth/Earth.jpg", SkyFactory.EnvMapType.EquirectMap);
        rootNode.attachChild(sky);
        
        Geometry box = new Geometry("", new Box(5,5,5));
        mat = new Material(getAssetManager(), "Common/MatDefs/Misc/Unshaded.j3md");
        Texture noise = getAssetManager().loadTexture("Interface/Logo/Monkey.jpg");
        ...
        // hand wands
        leftHand = (Geometry)getAssetManager().loadModel("Models/Controller/vive_controller.j3o");
        rightHand = leftHand.clone();
        Material handMat = new Material(getAssetManager(), "Common/MatDefs/Misc/Unshaded.j3md");
        handMat.setTexture("ColorMap", getAssetManager().loadTexture("Textures/Controller/vive_controller.png"));
    ...
    public static void main(String[] args){
    	...
    	settings.setRenderer(AppSettings.LWJGL_OPENGL33); // Setting the renderer. OpenGL 3 is needed if you're using Instance Rendering.
    	...
    	if (environment.isInitialized()){
            ...
            SimpleApplication test = new VRApplicationSample(vrAppState);
